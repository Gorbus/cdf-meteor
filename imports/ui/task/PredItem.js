...
export default class PredItem extends React.Component{
	constructor(props) {
		super(props)
	}
	...
	render() {
		return(
				<div className="poss-pred">
					...
					<div className="poss-pred__data poss-pred__data__pred-type">{this.props.type}</div>
					<div className="poss-pred__button poss-pred__button-remove" onClick={() => this.props.removePredecessor(this.props.task._id)}>Remove</div>
				</div>
			)
	}
}